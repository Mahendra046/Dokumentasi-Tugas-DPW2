                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/pro-big-2.jpg">
                                            <img class="d-block w-100" src="{{url("public",$produk->foto)}}" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/pro-big-3.jpg">
                                            <img class="d-block w-100" src="{{url("public",$produk->foto)}}" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/pro-big-4.jpg">
                                            <img class="d-block w-100" src="{{url("public",$produk->foto)}}" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <!-- Avaiable -->
                                <p class="avaibility">| Berat : {{$produk->berat}} kg  | Seller : {{$produk->seller->nama}}  </p>
                            </div>
