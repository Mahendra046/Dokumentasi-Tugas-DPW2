        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card">
                    ...
                    <div class="float-end">Jam : {{$timeServices->showTimeNow()}}</div>    
                    Filter
                    </div>
                    <div class="card-body">
                        <form action="{{url('admin/produk/filter')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="harga_max" value="{{$harga_min ?? ""}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <button class="btn btn-dark float-end mt-1"><i class="fa fa-search"></i>Filter</button>
                        </form>
                    </div>
                </div>
                <div class="card mt-2">
